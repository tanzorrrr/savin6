...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{route('admin.page.create')}}" class="btn btn-primary pull-right"><i class="fa fa-plus-square-o"></i> Создать cтраницу</a>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <form onsubmit="if(confirm('Удалить?')){return true}else{return false}"  action="{{route('admin.page.destroy',$page)}}" method="post">
                            ...
                            {{csrf_field()}}
                            <a class="btn-default" href="{{route('admin.page.edit', $page)}}"><i class="fa fa-edit"></i></a>
